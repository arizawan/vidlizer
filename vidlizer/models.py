...
_FALLBACK: list[dict] = [
    {"id": "google/gemini-2.5-flash",          "name": "Gemini 2.5 Flash",         "input_usd_per_1m": 0.15,  "output_usd_per_1m": 0.60,  "free": False},
    {"id": "google/gemini-2.5-flash-lite",     "name": "Gemini 2.5 Flash Lite",    "input_usd_per_1m": 0.075, "output_usd_per_1m": 0.30,  "free": False},
    {"id": "google/gemini-2.5-pro",            "name": "Gemini 2.5 Pro",           "input_usd_per_1m": 1.25,  "output_usd_per_1m": 10.0,  "free": False},
    {"id": "nvidia/nemotron-nano-12b-v2-vl:free", "name": "Nemotron Nano 12B (free)", "input_usd_per_1m": 0.0, "output_usd_per_1m": 0.0, "free": True},
    {"id": "google/gemma-4-31b-it:free",       "name": "Gemma 4 31B (free)",       "input_usd_per_1m": 0.0,  "output_usd_per_1m": 0.0,  "free": True},
    {"id": "openai/gpt-4o",                    "name": "GPT-4o",                   "input_usd_per_1m": 2.50,  "output_usd_per_1m": 10.0,  "free": False},
    {"id": "openai/gpt-4o-mini",               "name": "GPT-4o Mini",              "input_usd_per_1m": 0.15,  "output_usd_per_1m": 0.60,  "free": False},
]
...
def format_price_label(m: dict) -> str:
    """Short human label for model picker."""
    if m["free"]:
        return "free"
